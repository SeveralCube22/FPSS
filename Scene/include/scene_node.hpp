...
public:
	SceneNode(unsigned int actorId, std::string name, RenderPass pass, Bounds* bounds, glm::mat4x4 to, const glm::mat4x4* from=nullptr) {
		parent = parent;
	...
	virtual void setTransform(glm::mat4x4 to, const glm::mat4x4* from) override;
